...
fun <T: Number> T?.orElse(other: T): T {
    return this ?: other
}

fun Double?.orZero(): Double = this.orElse(0.0)
fun Float?.orZero(): Float = this.orElse(0f)
fun Int?.orZero(): Int = this.orElse(0)
fun Long?.orZero(): Long = this.orElse(0L)
...
fun ZonedDateTime.createTimeString(): String {
  ...
  fetched = if (today == fetchedDayOfWeek) {
    AppPreference.TIME_FORMATTER.format(this)
  } else {
    val day: String = DayOfWeek.from(this)
        .getDisplayName(SHORT, Locale.getDefault())
    val timeStr: String = AppPreference.TIME_FORMATTER.format(this)
    "$timeStr $day"
  }
  return fetched
}
...
//  when {
//    change > 0 -> {
//      text = View.getContext.getString(R.string.quote_change_pos, change)
//      textColor = ContextCompat.getColor(View.getContext, R.color.change_positive)
//    }
//    change < 0 -> {
//      text = View.getContext.getString(R.string.quote_change_neg, change)
//      textColor = ContextCompat.getColor(View.getContext, R.color.change_negative)
//    }
//    else -> {
//      text = View.getContext.getString(R.string.quote_change_neg, change)
...
//  when {
//    changePercent > 0 -> {
//      text = View.getContext.getString(R.string.quote_change_percent_pos, changePercent)
//      textColor = ContextCompat.getColor(View.getContext, R.color.change_positive)
//    }
//    changePercent < 0 -> {
//      text = View.getContext.getString(R.string.quote_change_percent_neg, changePercent)
//      textColor = ContextCompat.getColor(View.getContext, R.color.change_negative)
//    }
//    else -> {
//      text = View.getContext.getString(R.string.quote_change_percent_neg, changePercent)
