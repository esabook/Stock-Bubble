package com.stockbubble.dev.repo.data
...
data class QuoteRow(
  ...
  @ColumnInfo(name = "longName") val longName: String?,
  ...
  @ColumnInfo(name = "twoHundredDayAverageChange") val twoHundredDayAverageChange: Float?,
  @ColumnInfo(name = "twoHundredDayAverageChangePercent") val twoHundredDayAverageChangePercent: Float?,
  @ColumnInfo(name = "fiftyDayAverageChangePercent") val fiftyDayAverageChangePercent: Float?,
  ...
  @ColumnInfo(name = "averageAnalystRating") val averageAnalystRating: String?,
  @ColumnInfo(name = "averageDailyVolume3Month") val averageDailyVolume3Month: Long?,
  @ColumnInfo(name = "averageDailyVolume10Day") val averageDailyVolume10Day: Long?,
)
